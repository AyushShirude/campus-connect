...
export const events: EventItem[] = [
  { id: "e1", name: "AI & ML Workshop", category: "tech-events", description: "Hands-on workshop on artificial intelligence and machine learning fundamentals.", date: "2026-03-15", time: "10:00 AM", location: "Main Auditorium", fee: 50, image: techImg, status: "ongoing" },
  { id: "e2", name: "Web Dev Bootcamp", category: "tech-events", description: "Intensive full-stack web development bootcamp with React and Node.js.", date: "2026-03-20", time: "9:00 AM", location: "Computer Lab 1", fee: 50, image: techImg, status: "upcoming" },
  { id: "e3", name: "Robotics Challenge", category: "tech-events", description: "Design and program robots to complete challenging obstacle courses.", date: "2026-04-05", time: "11:00 AM", location: "Innovation Center", fee: 50, image: techImg, status: "upcoming" },
  { id: "e4", name: "Battle of Bands", category: "music-events", description: "Showcase your band's talent in this electrifying music competition.", date: "2026-03-18", time: "5:00 PM", location: "Open Air Theater", fee: 50, image: musicImg, status: "ongoing" },
  ...
  { id: "e6", name: "Cricket Tournament", category: "sports-events", description: "Inter-department cricket tournament with exciting prizes.", date: "2026-03-12", time: "8:00 AM", location: "Sports Ground", fee: 50, image: sportsImg, status: "ongoing" },
  { id: "e7", name: "Marathon 2026", category: "sports-events", description: "Annual university marathon open to all students and faculty.", date: "2026-04-10", time: "6:00 AM", location: "Campus Circuit", fee: 50, image: sportsImg, status: "upcoming" },
  { id: "e8", name: "Code Sprint 48", category: "hackathons", description: "48-hour hackathon to build solutions for real-world problems.", date: "2026-03-22", time: "9:00 AM", location: "Innovation Hub", fee: 50, image: hackathonImg, status: "ongoing" },
